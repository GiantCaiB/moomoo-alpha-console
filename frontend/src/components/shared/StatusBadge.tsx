...
const variants: Record<string, string> = {
  ...
  RUNNING: "bg-accent-blue/10 text-accent-blue border border-accent-blue/25",
  COMPLETED: "bg-accent-green/10 text-accent-green border border-accent-green/25",
  COMPLETED_WITH_ERRORS: "bg-accent-amber/10 text-accent-amber border border-accent-amber/25",
