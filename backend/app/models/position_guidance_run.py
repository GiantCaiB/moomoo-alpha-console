...
class PositionGuidanceRun(Base, UUIDMixin, TimestampMixin):
    __tablename__ = "position_guidance_runs"
    ...
    positions_scanned: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
